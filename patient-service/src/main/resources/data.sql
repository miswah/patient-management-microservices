-- Ensure the 'patient' table exists (UUID stored as BINARY(16))
...
VALUES
(
    UNHEX(REPLACE('123e4567-e89b-12d3-a456-426614174002', '-', '')),
    'Alice Johnson',
...
VALUES
(
    UNHEX(REPLACE('123e4567-e89b-12d3-a456-426614174003', '-', '')),
    'Bob Brown',
...
VALUES
(
    UNHEX(REPLACE('123e4567-e89b-12d3-a456-426614174004', '-', '')),
    'Emily Davis',
...
VALUES
(
    UNHEX(REPLACE('223e4567-e89b-12d3-a456-426614174005', '-', '')),
    'Michael Green',
...
VALUES
(
    UNHEX(REPLACE('223e4567-e89b-12d3-a456-426614174006', '-', '')),
    'Sarah Taylor',
...
VALUES
(
    UNHEX(REPLACE('223e4567-e89b-12d3-a456-426614174007', '-', '')),
    'David Wilson',
...
VALUES
(
    UNHEX(REPLACE('223e4567-e89b-12d3-a456-426614174008', '-', '')),
    'Laura White',
...
VALUES
(
    UNHEX(REPLACE('223e4567-e89b-12d3-a456-426614174009', '-', '')),
    'James Harris',
...
VALUES
(
    UNHEX(REPLACE('223e4567-e89b-12d3-a456-426614174010', '-', '')),
    'Emma Moore',
...
VALUES
(
    UNHEX(REPLACE('223e4567-e89b-12d3-a456-426614174011', '-', '')),
    'Ethan Martinez',
...
VALUES
(
    UNHEX(REPLACE('223e4567-e89b-12d3-a456-426614174012', '-', '')),
    'Sophia Clark',
...
VALUES
(
    UNHEX(REPLACE('223e4567-e89b-12d3-a456-426614174013', '-', '')),
    'Daniel Lewis',
...
VALUES
(
    UNHEX(REPLACE('223e4567-e89b-12d3-a456-426614174014', '-', '')),
    'Isabella Walker',
